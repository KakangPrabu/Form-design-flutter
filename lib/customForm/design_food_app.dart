...
void main() => runApp(food_design());

class food_design extends StatelessWidget {
...
var bannerImage = [
  ...
  "assets/images/food/cheesechilly.jpg",
  "assets/images/food/noodles.jpg",
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          "Foodies",
                          style: TextStyle(fontSize: 50, fontFamily: "Thin"),
                        ),
...
class BannerWidgetArea extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    PageController controller = PageController(viewportFraction: 0.6, initialPage: 1);
